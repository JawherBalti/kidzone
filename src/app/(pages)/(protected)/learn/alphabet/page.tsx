...
function AlphabetPage() {
  ...
  useEffect(() => {
    const fetchProgress = async () => {
      try {
        // setLoading(true);
        const response = await progressService.getLessonProgress("alphabet");
  ...
  const handleNext = async () => {
    ...
    if (user) {
      ...
      try {
        await progressService.updateLessonProgress("alphabet", {
...
export default withAuth(AlphabetPage);
