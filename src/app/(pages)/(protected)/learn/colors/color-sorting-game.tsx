    ...
    if (isCorrect) {
      ...
      const updatedBins = bins.map((b) =>
        b.color === bin.color
          ? {
              ...b,
              acceptedObjects: [...b.acceptedObjects, draggedObject],
            }
          : b
      );
      setBins(updatedBins);
    ...
    <div className="flex-1 w-full bg-gradient-to-b from-purple-100 to-pink-100 rounded-3xl border-4 border-yellow-400 p-5">
      ...
      {gameState === "success" ? (
        <SuccessModal
          score={score}
          resetGame={resetGame}
          setIsPlayingGame={setIsPlayingColorSortingGame}
        />
      ) : (
        <div className="flex flex-col-reverse lg:flex-row gap-3">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-yellow-50 p-4 rounded-2xl border-2 border-yellow-200">
                  ...
                  <ul className="text-sm text-yellow-700 space-y-2">
                    <li>
                      Help sort the objects by dragging them to their correct
                      color bins!
                    </li>
                  </ul>
                </div>
          ...
          <div className="flex-1">
            <div className="relative flex justify-center items-center h-full bg-white rounded-3xl p-6 shadow-2xl border-4 border-green-400">
                  ...
                  {bins.map((bin) => (
                    ...
                    >
                      ...
                      <div className="absolute bottom-4 left-4 right-4 flex justify-center gap-1 flex-wrap">
                        {bin.acceptedObjects.map((obj) => (
                          <span key={obj.id} className="text-2xl">
                            {obj.emoji}
                          </span>
                        ))}
                      </div>
