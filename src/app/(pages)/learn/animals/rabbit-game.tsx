        ...
        const animateJump = (currentTime: number) => {
            ...
            if (progress < 1) {
                ...
                const animateFall = (fallTime: number) => {
                    ...
                    const fallY =
                        jumpHeight +
                        (startY - jumpHeight) * easeIn(fallProgress);
    ...
    useEffect(() => {
        ...
        const gameLoop = (currentTime: number) => {
            ...
            setObstacles((prev) => {
                const updated = prev
                    .map((obs) => ({
                        ...
                        position:
                            obs.position -
                            gameStateRef.current.speed * deltaTime * 0.03,
                    }))
                ...
                updated.forEach((obs) => {
                    if (obs.position < 25 && obs.position > 20) {
                        ...
                        const isRabbitOnGround =
                            gameStateRef.current.rabbitPosition >= 15;
                        const isRabbitJumping =
                            gameStateRef.current.rabbitPosition < 15;
            ...
            if (treeSpawnTimer > randomSpawnInterval) {
                ...
                const size =
                    randomLayer === "far" ? 6 : randomLayer === "mid" ? 4 : 5;
                        ...
                        <div className="flex flex-col items-center justify-center h-full">
                            <div className="bg-yellow-50 p-4 rounded-2xl border-2 border-yellow-200 mb-6 max-w-md">
                                ...
                                <ul className="text-sm text-yellow-700 space-y-2">
                                    <li>
                                        • <strong>SPACEBAR</strong> - Jump over
                                        obstacles
                                    </li>
                                    <li>
                                        • <strong>Relaxed speed</strong> - Easy
                                        to react
                                    </li>
                                    <li>
                                        • <strong>fox 🦊 & Rocks 🪨</strong> -
                                        Jump over them
                                    </li>
                                    <li>
                                        • <strong>Birds 🦅</strong> - Stay on
                                        ground
                                    </li>
                                    <li>
                                        • <strong>Gradual difficulty</strong> -
