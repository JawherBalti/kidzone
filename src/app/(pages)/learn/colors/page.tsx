            ...
            case "learning":
                return (
                    <div className="text-center">
                        <motion.div
                            className={`w-24 h-24 rounded-2xl mx-auto mb-4 shadow-2xl border-4 border-white ${current.tailwindColor}`}
                            ...
                            <div className="bg-purple-100 p-4 rounded-2xl border-2 border-purple-300 max-w-md mx-auto mb-6">
                                <div className="flex justify-center items-center gap-5 text-lg text-purple-700">
                                    ...
                                    {current.mixedFrom.map((color, idx) => (
                                        ...
                                        >
                                            <div
                                                className={`bg-${color} w-[20px] h-[20px]`}
                                            ></div>
                                            {idx === 0 ? "+" : ""}
                                        </div>
                                    ))}
                    ...
                    <div className="text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                            {current.options?.map((color, index) => {
                                const colorData = learningColors.find(
                                    (c) => c.name === color
                                );
                                return (
                                    <motion.button
                        ...
                        <div className="grid grid-cols-1 gap-4 max-w-md mx-auto">
                            {current.options?.map((mix, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`bg-${color1}-500 w-8 h-8`}
                                        ></div>
                                        +
                                        <div
                                            className={`bg-${color2}-500 w-8 h-8`}
                                        ></div>
                                    </motion.button>
                                );
                            })}
