...
import FarmToTableJourney from "./game";
import NutritionBall from "./game";
// import FoodMatchingGame from "./food-matching-game";
// import NutritionChef from "./nutrition-chef";
...
export default function FoodNutritionPage() {
  ...
  return (
    <div className="flex-1 w-full lg:max-h-[calc(100vh-130px)]  bg-gradient-to-b from-green-50 to-blue-50 p-5">
      {!isPlayingSnakeFeast && !isPlayingSnake ? (
        // <div className="lg:max-h-[calc(100vh-165px)] flex flex-col lg:flex-row gap-5 max-w-6xl mx-auto">
        //   {/* Main Learning Area */}
        //   <div className="flex-1 flex flex-col items-center justify-center bg-white rounded-3xl p-8 shadow-2xl border-4 border-green-200">
        ...
        //           setIsPlayingGame2={()=>{}}
        //           gameName2="Nutrition Chef"
        //           gameImage2="/assets/nutritionChef.png"
        //         />
        //       ) : (
        //         <motion.div
        //           key={current.id}
...
:      isPlayingSnake ? null : // <FoodMatchingGame setIsPlayingFoodMatching={setIsPlayingFoodMatching} />
      null}
    </div>
  );
}
