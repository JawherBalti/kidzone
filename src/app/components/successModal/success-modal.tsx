...
const SuccessModal = ({ score, resetGame, setIsPlayingGame }: any) => {
  return (
    <div className="flex-1 w-full h-full rounded-3xl bg-gradient-to-br from-green-100 to-yellow-100 flex items-center justify-center">
      <motion.div
        ...
        className="bg-white rounded-3xl p-8 shadow-2xl border-4 border-green-300 max-w-md text-center"
      >
        <div className="text-6xl mb-4">🎉</div>
        <h1 className="text-4xl font-bold text-gray-800 mb-4">{score > 100 ? "You Win!" : "Try Again!"}</h1>
        {score ? (
